...
import './ISReleasesTimeline.css';

const COOKIE = 'DASHBOARD_USER';

class ISReleasesTimeline extends Widget {
        ...
        return (
            <Scrollbars style={{height: this.state.height}}>
                <div className="timeline-wrapper">
                    ...
                    <img src={islogo} width="200" height="30" />
...
global.dashboard.registerWidget('ISReleasesTimeline', ISReleasesTimeline);